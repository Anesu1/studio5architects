...
export async function getBlogPostBySlug(slug: string): Promise<BlogPost | null> {
  try {
    const result = await client.fetch<BlogPost | null>(
...
export const STATIC_BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Design fees are an investment in accuracy. A well-detailed set of plans reduces ambiguity on site, which is the leading cause of construction cost overruns. Our use of BIM allows us to detect clashes and quantify materials precisely before construction begins.',
      'Construction costs are influenced by site topography, utility access, and the finish level of the building. We work closely with quantity surveyors to provide regular cost updates throughout the design phases.',
      'In a fluctuating market, contingency planning is non-negotiable. We recommend a 10–15% buffer to accommodate unforeseen site conditions or price changes in imported materials.',
    ],
  },
  {
    ...
    readTime: '5 min read',
    content: [
      'Virtual Reality has moved beyond a novelty to become an essential tool in our design process. At Studio5, we use immersive VR to bridge the gap between 2D plans and 3D reality, allowing clients to "walk through" their buildings before a single brick is laid.',
      'This immersive experience helps in making critical decisions about spatial scale, lighting, and interior finishes. Seeing a room\'s volume and how natural light interacts with the space in real-time provides a level of confidence that traditional renderings cannot match.',
      'VR also acts as a powerful coordination tool. It allows technical teams to identify potential clashes or design inconsistencies early in the development phase, significantly reducing the likelihood of costly changes during construction.',
      'As we continue to embrace spatial computing, our goal is to make the design journey as transparent and exciting as possible for our clients.',
    ],
  },
  {
    ...
    readTime: '7 min read',
    content: [
      'In a world where "sustainability" has become a buzzword, it is crucial to distinguish between surface-level green-washing and meaningful ecological design. For Studio5, green design is not a fictional ideal—it is a functional necessity.',
      ...
      'We also focus on water security and resource management. In the Zimbabwean context, integrating greywater recycling, rainwater harvesting, and solar energy systems into the initial design is key to creating resilient buildings.',
  ...
  },
  {
    ...
    content: [
      ...
      'As we move forward, Studio5 remains committed to designing residences that respect our architectural heritage while boldly embracing the technologies and aesthetics of the future.',
    ],
  },
];
